...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_right_ball(
    ...
    SSNP_VRT , _______  , KC_4     , KC_5     , KC_6     ,S(KC_SCLN),                            KC_PGUP  , MS_BTN1  , KC_DOWN  , MS_BTN2  , MS_BTN3  , _______  ,
  ...
  [3] = LAYOUT_right_ball(
    ...
    UG_NEXT  , UG_HUEU  , UG_SATU  , UG_VALU  , _______  , SCRL_DVI ,                            RGB_M_X  , RGB_M_G  , RGB_M_T  , RGB_M_TW , _______  , _______  ,
    UG_PREV , UG_HUED  , UG_SATD  , UG_VALD  , _______  , SCRL_DVD , QK_BOOT  ,      EE_CLR   , CPI_D1K  , CPI_D100 , CPI_I100 , CPI_I1K  , KBC_SAVE , KBC_RST  ,
